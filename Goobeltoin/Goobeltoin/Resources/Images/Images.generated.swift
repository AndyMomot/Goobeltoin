...
internal enum Asset {
  ...
  internal static let advertisingCars = ImageAsset(name: "advertisingCars")
  internal static let bankDeposit = ImageAsset(name: "bankDeposit")
  internal static let business = ImageAsset(name: "business")
  internal static let buyingBonds = ImageAsset(name: "buyingBonds")
  internal static let cryptocurrency = ImageAsset(name: "cryptocurrency")
  internal static let infoProducts = ImageAsset(name: "infoProducts")
  internal static let intellectualProperty = ImageAsset(name: "intellectualProperty")
  internal static let rentingEquipmentTransport = ImageAsset(name: "rentingEquipmentTransport")
  internal static let rentingHousing = ImageAsset(name: "rentingHousing")
  internal static let vendingMachines = ImageAsset(name: "vendingMachines")
  internal static let camera = ImageAsset(name: "camera")
  internal static let pencile = ImageAsset(name: "pencile")
  ...
  internal static let loadingBackground = ImageAsset(name: "loadingBackground")
  internal static let logo = ImageAsset(name: "logo")
  internal static let logoTitle = ImageAsset(name: "logoTitle")
  internal static let notificationsIcon = ImageAsset(name: "notificationsIcon")
